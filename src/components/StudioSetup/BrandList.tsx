    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="font-sans text-base text-muted-foreground mt-2 max-w-sm">
        ...
        {brands.map((brand) => {
          ...
          return (
              ...
              className={`
                ...
                ${
                  isActive
                    ...
                    : 'border-border bg-card/50 hover:bg-card hover:shadow-elevated hover:border-muted-foreground/30'
                }
              `}
            ...
            >
              ...
              <div className="flex gap-1 pt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-[150ms]">
                <button
                  onClick={(e) => { e.stopPropagation(); onEdit(brand); }}
                  className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground px-2 py-1 rounded-md hover:bg-secondary transition-all duration-[100ms]"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-xs text-destructive hover:text-destructive px-2 py-1 rounded-md hover:bg-destructive/10 transition-all duration-[100ms]"
                >
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
