...
export function PieceCard({
  ...
  return (
    <div
      className={`group relative flex flex-col rounded-xl border bg-card overflow-hidden shadow-subtle transition-all duration-[150ms] hover:shadow-elevated hover:border-muted-foreground/30 ${
    ...
    >
      ...
      {piece.edited && (
        <span className="absolute top-3 right-3 z-10 px-2 py-0.5 rounded-full bg-accent text-accent-foreground font-sans text-[10px] font-semibold uppercase tracking-widest">
          Editado
        </span>
      )}
      ...
      <div className="flex flex-col gap-4 p-5">
        <div className="flex items-start justify-between gap-2">
          ...
          <span
            className={`shrink-0 inline-flex items-center px-2 py-0.5 rounded-full font-sans text-[10px] font-semibold uppercase tracking-widest overflow-hidden ${platformClass}`}
          >
