    ...
    <div className="flex flex-col gap-10 overflow-hidden animate-in">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {selectionMode && selectedIds.size > 0 && (
            <Button variant="secondary" size="sm" onClick={handleExportSelection}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 overflow-hidden">
        {formatIds.map((formatId, index) => {
          ...
          return (
            <div key={formatId} className="piece-card" style={{ animationDelay: `${index * 60}ms` }}>
              <PieceCard
                piece={piece}
                ...
                onVariationChange={(v) => setActiveVariations((prev) => ({ ...prev, [formatId]: v }))}
              />
            </div>
          );
        })}
